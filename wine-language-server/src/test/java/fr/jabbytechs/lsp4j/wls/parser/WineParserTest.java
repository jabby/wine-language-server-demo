...
public class WineParserTest {
	...
	public void testParse() throws Exception {
		...
		WineNavigator navigator = new WineNavigator(dataBuffer, elementBuffer);
	...
	@Test
	@Ignore
	public void testParseWithUnknow() throws Exception {

		Path path = Paths.get(ClassLoader.getSystemResource("example-with-unknow.wd").toURI());
